          ...
          <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
            <div>
              ...
              <p className="font-medium text-gray-500 dark:text-gray-400">
                The model is trained to predict the issue category, language
            ...
            <div>
              ...
              <p className="font-medium text-gray-500 dark:text-gray-400">
                Python’s FastAPI framework enables engineers to rapidly build
            ...
            <div>
              ...
              <p className="font-medium text-gray-500 dark:text-gray-400">
                Reacts popularity and usage are increasing day by day for good
            ...
            <div>
              <h3 className="mb-2 text-3xl font-bold dark:text-white">
                Trained with Cusomer Queries
              </h3>
              <p className="font-medium text-gray-500 dark:text-gray-400">
                Model has been trained with the Bitext - Customer Service Tagged
